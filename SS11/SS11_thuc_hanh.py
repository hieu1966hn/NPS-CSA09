...
### Bài 3: 
# df.to_csv('./SS11/provinces.csv', index=False)
...
#     print(city, end=', ')
# print(df.loc[len(df) - 1, 'Name']) ### Thay câu này thành iloc ...

### Bài 2: 
# list_cities = df.loc[df['Division'] == 'Thành phố Trung ương', ['Name', 'Region']]
# print(list_cities)

### Bài 3: 
# regions_count = df['Region'].value_counts() ## Loại bỏ những giá trị trùng lặp
# print(len(regions_count))

# Bài 4. Dân Số
# Tìm tỉnh/thành phố có dân số đông nhất và tỉnh/thành phố có dân số ít nhất.
